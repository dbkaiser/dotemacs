...
;;;;;;  org-columns) "org-colview" "org-colview.el" (21055 51931))
...
;;;;;;  org-babel-pop-to-session-maybe org-babel-load-in-session-maybe
;;;;;;  org-babel-expand-src-block-maybe org-babel-view-src-block-info
;;;;;;  org-babel-execute-maybe org-babel-execute-safely-maybe) "org/ob-core"
;;;;;;  "../../../org/ob-core.el" "5020331fabde60f15398bf24d3981977")
;;; Generated autoloads from ../../../org/ob-core.el

(autoload 'org-babel-execute-safely-maybe "org/ob-core" "\


\(fn)" nil nil)

(autoload 'org-babel-execute-maybe "org/ob-core" "\


\(fn)" t nil)

(autoload 'org-babel-view-src-block-info "org/ob-core" "\
Display information on the current source block.
This includes header arguments, language and name, and is largely
a window into the `org-babel-get-src-block-info' function.
...
(autoload 'org-babel-expand-src-block-maybe "org/ob-core" "\
Conditionally expand a source block.
Detect if this is context for a org-babel src-block and if so
then run `org-babel-expand-src-block'.
...
(autoload 'org-babel-load-in-session-maybe "org/ob-core" "\
Conditionally load a source block in a session.
Detect if this is context for a org-babel src-block and if so
then run `org-babel-load-in-session'.
...
(autoload 'org-babel-pop-to-session-maybe "org/ob-core" "\
Conditionally pop to a session.
Detect if this is context for a org-babel src-block and if so
then run `org-babel-switch-to-session'.
...
(autoload 'org-babel-execute-src-block "org/ob-core" "\
Execute the current source code block.
Insert the results of execution into the buffer.  Source code
execution and the collection and formatting of results can be
controlled through a variety of header arguments.
...
(autoload 'org-babel-expand-src-block "org/ob-core" "\
Expand the current source code block.
Expand according to the source code block's header
arguments and pop open the results in a preview buffer.
...
(autoload 'org-babel-check-src-block "org/ob-core" "\
Check for misspelled header arguments in the current code block.

\(fn)" t nil)

(autoload 'org-babel-insert-header-arg "org/ob-core" "\
Insert a header argument selecting from lists of common args and values.

\(fn)" t nil)

(autoload 'org-babel-load-in-session "org/ob-core" "\
Load the body of the current source-code block.
Evaluate the header arguments for the source block before
entering the session.  After loading the body this pops open the
session.
...
(autoload 'org-babel-initiate-session "org/ob-core" "\
Initiate session for current code block.
If called with a prefix argument then resolve any variable
references in the header arguments and assign these variables in
the session.  Copy the body of the code block to the kill ring.
...
(autoload 'org-babel-switch-to-session "org/ob-core" "\
Switch to the session of the current code block.
Uses `org-babel-initiate-session' to start the session.  If called
with a prefix argument then this is passed on to
`org-babel-initiate-session'.
...
(autoload 'org-babel-switch-to-session-with-code "org/ob-core" "\
Switch to code buffer and display session.

\(fn &optional ARG INFO)" t nil)

(autoload 'org-babel-open-src-block-result "org/ob-core" "\
If `point' is on a src block then open the results of the
source code block, otherwise return nil.  With optional prefix
argument RE-RUN the source-code block is evaluated even if
results already exist.
...
(autoload 'org-babel-map-src-blocks "org/ob-core" "\
Evaluate BODY forms on each source-block in FILE.
If FILE is nil evaluate BODY forms on source blocks in current
buffer.  During evaluation of BODY the following local variables
are set relative to the currently matched code block.
...
(autoload 'org-babel-map-inline-src-blocks "org/ob-core" "\
Evaluate BODY forms on each inline source-block in FILE.
If FILE is nil evaluate BODY forms on source blocks in current
buffer.
...
(autoload 'org-babel-map-call-lines "org/ob-core" "\
Evaluate BODY forms on each call line in FILE.
If FILE is nil evaluate BODY forms on source blocks in current
buffer.
...
(autoload 'org-babel-map-executables "org/ob-core" "\
...
(autoload 'org-babel-execute-buffer "org/ob-core" "\
Execute source code blocks in a buffer.
Call `org-babel-execute-src-block' on every source block in
the current buffer.
...
(autoload 'org-babel-execute-subtree "org/ob-core" "\
Execute source code blocks in a subtree.
Call `org-babel-execute-src-block' on every source block in
the current subtree.
...
(autoload 'org-babel-sha1-hash "org/ob-core" "\
Generate an sha1 hash based on the value of info.

\(fn &optional INFO)" t nil)

(autoload 'org-babel-hide-result-toggle-maybe "org/ob-core" "\
Toggle visibility of result at point.

\(fn)" t nil)

(autoload 'org-babel-goto-src-block-head "org/ob-core" "\
Go to the beginning of the current code block.

\(fn)" t nil)

(autoload 'org-babel-goto-named-src-block "org/ob-core" "\
Go to a named source-code block.

\(fn NAME)" t nil)

(autoload 'org-babel-goto-named-result "org/ob-core" "\
Go to a named result.

\(fn NAME)" t nil)

(autoload 'org-babel-next-src-block "org/ob-core" "\
Jump to the next source block.
With optional prefix argument ARG, jump forward ARG many source blocks.

\(fn &optional ARG)" t nil)

(autoload 'org-babel-previous-src-block "org/ob-core" "\
Jump to the previous source block.
With optional prefix argument ARG, jump backward ARG many source blocks.

\(fn &optional ARG)" t nil)

(autoload 'org-babel-mark-block "org/ob-core" "\
Mark current src block.
...
;;;***

;;;### (autoloads (org-babel-describe-bindings) "org/ob-keys" "../../../org/ob-keys.el"
;;;;;;  "f41a561a02eb66238c2824e76e3f8cc8")
;;; Generated autoloads from ../../../org/ob-keys.el

(autoload 'org-babel-describe-bindings "org/ob-keys" "\
Describe all keybindings behind `org-babel-key-prefix'.
...

;;;### (autoloads (org-babel-lob-get-info org-babel-lob-execute-maybe)
;;;;;;  "org/ob-lob" "../../../org/ob-lob.el" "d94d0930566ed1471ffe0d04603ac1bc")
;;; Generated autoloads from ../../../org/ob-lob.el

(autoload 'org-babel-lob-execute-maybe "org/ob-lob" "\
Execute a Library of Babel source block, if appropriate.
Detect if this is context for a Library Of Babel source block and
if so then run the appropriate source block from the Library.
...
(autoload 'org-babel-lob-get-info "org/ob-lob" "\
Return a Library of Babel function call as a string.
...
;;;***

;;;### (autoloads (org-babel-tangle org-babel-tangle-file) "org/ob-tangle"
;;;;;;  "../../../org/ob-tangle.el" "4be192fcb6c6b0ed49ed439b74cbc014")
;;; Generated autoloads from ../../../org/ob-tangle.el

(autoload 'org-babel-tangle-file "org/ob-tangle" "\
Extract the bodies of source code blocks in FILE.
Source code blocks are extracted with `org-babel-tangle'.
Optional argument TARGET-FILE can be used to specify a default
export file for all source blocks.  Optional argument LANG can be
...
(autoload 'org-babel-tangle "org/ob-tangle" "\
Write code blocks to source-specific files.
Extract the bodies of all source code blocks from the current
file into their own source-specific files.
With one universal prefix argument, only tangle the block at point.
...
;;;### (autoloads (org-archive-subtree-default-with-confirmation
;;;;;;  org-archive-subtree-default org-toggle-archive-tag org-archive-to-archive-sibling
;;;;;;  org-archive-subtree) "org/org-archive" "../../../org/org-archive.el"
;;;;;;  "bc3cb1755c5b20dc90bde801f0202eca")
;;; Generated autoloads from ../../../org/org-archive.el

(autoload 'org-archive-subtree "org/org-archive" "\
Move the current subtree to the archive.
The archive can be a certain top-level heading in the current file, or in
a different file.  The tree will be moved to that location, the subtree
heading be marked DONE, and the current time will be added.
...
(autoload 'org-archive-to-archive-sibling "org/org-archive" "\
Archive the current heading by moving it under the archive sibling.
The archive sibling is a sibling of the heading with the heading name
`org-archive-sibling-heading' and an `org-archive-tag' tag.  If this
sibling does not exist, it will be created at the end of the subtree.
...
(autoload 'org-toggle-archive-tag "org/org-archive" "\
Toggle the archive tag for the current headline.
With prefix ARG, check all children of current headline and offer tagging
the children that do not contain any open TODO items.
...
(autoload 'org-archive-subtree-default "org/org-archive" "\
Archive the current subtree with the default command.
This command is set with the variable `org-archive-default-command'.

\(fn)" t nil)

(autoload 'org-archive-subtree-default-with-confirmation "org/org-archive" "\
Archive the current subtree with the default command.
This command is set with the variable `org-archive-default-command'.
...
;;;***

;;;### (autoloads (org-attach) "org/org-attach" "../../../org/org-attach.el"
;;;;;;  "2acf3dc22dcf986b2dbf07e1c0f4bba4")
;;; Generated autoloads from ../../../org/org-attach.el

(autoload 'org-attach "org/org-attach" "\
The dispatcher for attachment commands.
Shows a list of commands and prompts for another key to execute a command.
...
;;;***

;;;### (autoloads (org-bbdb-anniversaries) "org/org-bbdb" "../../../org/org-bbdb.el"
;;;;;;  "867e99974c8aab087ba115fc8f89e956")
;;; Generated autoloads from ../../../org/org-bbdb.el

(autoload 'org-bbdb-anniversaries "org/org-bbdb" "\
Extract anniversaries from BBDB for display in the agenda.
...
;;;;;;  org-clock-display org-clock-sum org-clock-goto org-clock-cancel
;;;;;;  org-clock-out org-clock-in-last org-clock-in org-resolve-clocks)
;;;;;;  "org/org-clock" "../../../org/org-clock.el" "f999bab8b47b8a6252326354ab4c7908")
;;; Generated autoloads from ../../../org/org-clock.el

(autoload 'org-resolve-clocks "org/org-clock" "\
Resolve all currently open org-mode clocks.
If `only-dangling-p' is non-nil, only ask to resolve dangling
\(i.e., not currently open and valid) clocks.
...
(autoload 'org-clock-in "org/org-clock" "\
Start the clock on the current item.
If necessary, clock-out of the currently active clock.
With a prefix argument SELECT (\\[universal-argument]), offer a list of recently clocked
tasks to clock into.  When SELECT is \\[universal-argument] \\[universal-argument], clock into the current task
...
(autoload 'org-clock-in-last "org/org-clock" "\
Clock in the last closed clocked item.
When already clocking in, send an warning.
With a universal prefix argument, select the task you want to
clock in from the last clocked in tasks.
...
(autoload 'org-clock-out "org/org-clock" "\
Stop the currently running clock.
Throw an error if there is no running clock and FAIL-QUIETLY is nil.
With a universal prefix, prompt for a state to switch the clocked out task
to, overriding the existing value of `org-clock-out-switch-to-state'.
...
(autoload 'org-clock-cancel "org/org-clock" "\
Cancel the running clock by removing the start timestamp.

\(fn)" t nil)

(autoload 'org-clock-goto "org/org-clock" "\
Go to the currently clocked-in entry, or to the most recently clocked one.
With prefix arg SELECT, offer recently clocked tasks for selection.

\(fn &optional SELECT)" t nil)

(autoload 'org-clock-sum "org/org-clock" "\
Sum the times for each subtree.
Puts the resulting times in minutes as a text property on each headline.
TSTART and TEND can mark a time range to be considered.
HEADLINE-FILTER is a zero-arg function that, if specified, is called for
...
(autoload 'org-clock-display "org/org-clock" "\
Show subtree times in the entire buffer.
If TOTAL-ONLY is non-nil, only show the total time for the entire file
in the echo area.
...
(autoload 'org-clock-get-clocktable "org/org-clock" "\
Get a formatted clocktable with parameters according to PROPS.
The table is created in a temporary buffer, fully formatted and
fontified, and then returned.
...
(autoload 'org-clock-report "org/org-clock" "\
Create a table containing a report about clocked time.
If the cursor is inside an existing clocktable block, then the table
will be updated.  If not, a new clocktable will be inserted.  The scope
of the new clock will be subtree when called from within a subtree, and
...
(autoload 'org-dblock-write:clocktable "org/org-clock" "\
Write the standard clocktable.
...
;;;***

;;;### (autoloads (org-datetree-find-date-create) "org/org-datetree"
;;;;;;  "../../../org/org-datetree.el" "954f9d30ea6ea9b72b310bba030ca9a4")
;;; Generated autoloads from ../../../org/org-datetree.el

(autoload 'org-datetree-find-date-create "org/org-datetree" "\
Find or create an entry for DATE.
If KEEP-RESTRICTION is non-nil, do not widen the buffer.
When it is nil, the buffer will be widened to make sure an existing date
tree can be found.
...

;;;### (autoloads (org-element-context org-element-at-point org-element-interpret-data)
;;;;;;  "org/org-element" "../../../org/org-element.el" "40963ed55ee478e87d9b5d7252b51b9d")
;;; Generated autoloads from ../../../org/org-element.el

(autoload 'org-element-interpret-data "org/org-element" "\
Interpret DATA as Org syntax.
...
(autoload 'org-element-at-point "org/org-element" "\
Determine closest element around point.
...
(autoload 'org-element-context "org/org-element" "\
Return closest element or object around point.
...

;;;### (autoloads (org-feed-show-raw-feed org-feed-goto-inbox org-feed-update
;;;;;;  org-feed-update-all) "org/org-feed" "../../../org/org-feed.el"
;;;;;;  "f5f190118c0e7321f88972d9a4749f5f")
;;; Generated autoloads from ../../../org/org-feed.el

(autoload 'org-feed-update-all "org/org-feed" "\
Get inbox items from all feeds in `org-feed-alist'.

\(fn)" t nil)

(autoload 'org-feed-update "org/org-feed" "\
Get inbox items from FEED.
FEED can be a string with an association in `org-feed-alist', or
it can be a list structured like an entry in `org-feed-alist'.
...
(autoload 'org-feed-goto-inbox "org/org-feed" "\
Go to the inbox that captures the feed named FEED.

\(fn FEED)" t nil)

(autoload 'org-feed-show-raw-feed "org/org-feed" "\
Show the raw feed buffer of a feed.
...
;;;***

;;;### (autoloads (org-footnote-normalize org-footnote-action) "org/org-footnote"
;;;;;;  "../../../org/org-footnote.el" "498ce4bcc019503ef9657f915606b130")
;;; Generated autoloads from ../../../org/org-footnote.el

(autoload 'org-footnote-action "org/org-footnote" "\
Do the right thing for footnotes.
...
(autoload 'org-footnote-normalize "org/org-footnote" "\
Collect the footnotes in various formats and normalize them.
...

;;;### (autoloads (org-id-store-link org-id-find-id-file org-id-update-id-locations
;;;;;;  org-id-find org-id-goto org-id-get org-id-get-create) "org/org-id"
;;;;;;  "../../../org/org-id.el" "058cecf9786ef0ba525ed56f747a79e0")
;;; Generated autoloads from ../../../org/org-id.el

(autoload 'org-id-get-create "org/org-id" "\
Create an ID for the current entry and return it.
If the entry already has an ID, just return it.
With optional argument FORCE, force the creation of a new ID.
...
(autoload 'org-id-get "org/org-id" "\
Get the ID property of the entry at point-or-marker POM.
If POM is nil, refer to the entry at point.
If the entry does not have an ID, the function returns nil.
However, when CREATE is non nil, create an ID if none is present already.
...
(autoload 'org-id-goto "org/org-id" "\
Switch to the buffer containing the entry with id ID.
Move the cursor to that entry in that buffer.

\(fn ID)" t nil)

(autoload 'org-id-find "org/org-id" "\
Return the location of the entry with the id ID.
The return value is a cons cell (file-name . position), or nil
if there is no entry with that ID.
With optional argument MARKERP, return the position as a new marker.
...
(autoload 'org-id-update-id-locations "org/org-id" "\
Scan relevant files for IDs.
Store the relation between files and corresponding IDs.
This will scan all agenda files, all associated archives, and all
files currently mentioned in `org-id-locations'.
...
(autoload 'org-id-find-id-file "org/org-id" "\
Query the id database for the file in which this ID is located.

\(fn ID)" nil nil)

(autoload 'org-id-store-link "org/org-id" "\
Store a link to the current entry, using its ID.
...
;;;***

;;;### (autoloads (org-indent-mode) "org/org-indent" "../../../org/org-indent.el"
;;;;;;  "5257f4635c377537f302a83dc69419dd")
;;; Generated autoloads from ../../../org/org-indent.el

(autoload 'org-indent-mode "org/org-indent" "\
When active, indent text according to outline structure.
...
;;;***

;;;### (autoloads (org-irc-store-link) "org/org-irc" "../../../org/org-irc.el"
;;;;;;  "f5d45d21f475b63408f333384ce1cc61")
;;; Generated autoloads from ../../../org/org-irc.el

(autoload 'org-irc-store-link "org/org-irc" "\
Dispatch to the appropriate function to store a link to an IRC session.
...
;;;***

;;;### (autoloads (org-mobile-pull org-mobile-push) "org/org-mobile"
;;;;;;  "../../../org/org-mobile.el" "c69640ad752b53de4ac6874cbf252ec2")
;;; Generated autoloads from ../../../org/org-mobile.el

(autoload 'org-mobile-push "org/org-mobile" "\
Push the current state of Org affairs to the target directory.
This will create the index file, copy all agenda files there, and also
create all custom agenda views, for upload to the mobile phone.
...
(autoload 'org-mobile-pull "org/org-mobile" "\
Pull the contents of `org-mobile-capture-file' and integrate them.
Apply all flagged actions, flag entries to be flagged and then call an
agenda view showing the flagged items.
...
;;;***

;;;### (autoloads (org-plot/gnuplot) "org/org-plot" "../../../org/org-plot.el"
;;;;;;  "99a279b8b25fe56779d7c49fc617f1bf")
;;; Generated autoloads from ../../../org/org-plot.el

(autoload 'org-plot/gnuplot "org/org-plot" "\
Plot table using gnuplot.  Gnuplot options can be specified with PARAMS.
If not given options will be taken from the +PLOT
line directly before or after the table.
...
;;;;;;  org-table-import org-table-convert-region org-table-create
;;;;;;  org-table-create-or-convert-from-region org-table-create-with-table\.el)
;;;;;;  "org/org-table" "../../../org/org-table.el" "3c271d409dab6979db5a32f1f13820f5")
;;; Generated autoloads from ../../../org/org-table.el

(autoload 'org-table-create-with-table\.el "org/org-table" "\
Use the table.el package to insert a new table.
If there is already a table at point, convert between Org-mode tables
and table.el tables.
...
(autoload 'org-table-create-or-convert-from-region "org/org-table" "\
Convert region to table, or create an empty table.
If there is an active region, convert it to a table, using the function
`org-table-convert-region'.  See the documentation of that function
to learn how the prefix argument is interpreted to determine the field
...
(autoload 'org-table-create "org/org-table" "\
Query for a size and insert a table skeleton.
SIZE is a string Columns x Rows like for example \"3x2\".

\(fn &optional SIZE)" t nil)

(autoload 'org-table-convert-region "org/org-table" "\
Convert region to a table.
The region goes from BEG0 to END0, but these borders will be moved
slightly, to make sure a beginning of line in the first line is included.
...
(autoload 'org-table-import "org/org-table" "\
Import FILE as a table.
The file is assumed to be tab-separated.  Such files can be produced by most
spreadsheet and database applications.  If no tabs (at least one per line)
are found, lines will be split on whitespace into fields.
...
(autoload 'org-table-export "org/org-table" "\
Export table to a file, with configurable format.
Such a file can be imported into usual spreadsheet programs.
...
(autoload 'org-table-align "org/org-table" "\
Align the table at point by aligning all vertical bars.

\(fn)" t nil)

(autoload 'org-table-justify-field-maybe "org/org-table" "\
Justify the current field, text to left, number to right.
Optional argument NEW may specify text to replace the current field content.

\(fn &optional NEW)" nil nil)

(autoload 'org-table-next-field "org/org-table" "\
Go to the next field in the current table, creating new lines as needed.
Before doing so, re-align the table if necessary.

\(fn)" t nil)

(autoload 'org-table-previous-field "org/org-table" "\
Go to the previous field in the table.
Before doing so, re-align the table if necessary.

\(fn)" t nil)

(autoload 'org-table-next-row "org/org-table" "\
Go to the next row (same column) in the current table.
Before doing so, re-align the table if necessary.

\(fn)" t nil)

(autoload 'org-table-copy-down "org/org-table" "\
Copy a field down in the current column.
If the field at the cursor is empty, copy into it the content of
the nearest non-empty field above.  With argument N, use the Nth
non-empty field.  If the current field is not empty, it is copied
...
(autoload 'org-table-field-info "org/org-table" "\
Show info about the current field, and highlight any reference at point.

\(fn ARG)" t nil)

(autoload 'org-table-current-dline "org/org-table" "\
Find out what table data line we are in.
Only data lines count for this.

\(fn)" t nil)

(autoload 'org-table-goto-column "org/org-table" "\
Move the cursor to the Nth column in the current table line.
With optional argument ON-DELIM, stop with point before the left delimiter
of the field.
If there are less than N fields, just go to after the last delimiter.
...
(autoload 'org-table-insert-column "org/org-table" "\
Insert a new column into the table.

\(fn)" t nil)

(autoload 'org-table-delete-column "org/org-table" "\
Delete a column from the table.

\(fn)" t nil)

(autoload 'org-table-move-column-right "org/org-table" "\
Move column to the right.

\(fn)" t nil)

(autoload 'org-table-move-column-left "org/org-table" "\
Move column to the left.

\(fn)" t nil)

(autoload 'org-table-move-column "org/org-table" "\
Move the current column to the right.  With arg LEFT, move to the left.

\(fn &optional LEFT)" t nil)

(autoload 'org-table-move-row-down "org/org-table" "\
Move table row down.

\(fn)" t nil)

(autoload 'org-table-move-row-up "org/org-table" "\
Move table row up.

\(fn)" t nil)

(autoload 'org-table-move-row "org/org-table" "\
Move the current table line down.  With arg UP, move it up.

\(fn &optional UP)" t nil)

(autoload 'org-table-insert-row "org/org-table" "\
Insert a new row above the current line into the table.
With prefix ARG, insert below the current line.

\(fn &optional ARG)" t nil)

(autoload 'org-table-insert-hline "org/org-table" "\
Insert a horizontal-line below the current line into the table.
With prefix ABOVE, insert above the current line.

\(fn &optional ABOVE)" t nil)

(autoload 'org-table-hline-and-move "org/org-table" "\
Insert a hline and move to the row below that line.

\(fn &optional SAME-COLUMN)" t nil)

(autoload 'org-table-kill-row "org/org-table" "\
Delete the current row or horizontal line from the table.

\(fn)" t nil)

(autoload 'org-table-sort-lines "org/org-table" "\
Sort table lines according to the column at point.
...
(autoload 'org-table-cut-region "org/org-table" "\
Copy region in table to the clipboard and blank all relevant fields.
If there is no active region, use just the field at point.

\(fn BEG END)" t nil)

(autoload 'org-table-copy-region "org/org-table" "\
Copy rectangular region in table to clipboard.
A special clipboard is used which can only be accessed
with `org-table-paste-rectangle'.
...
(autoload 'org-table-paste-rectangle "org/org-table" "\
Paste a rectangular region into a table.
The upper right corner ends up in the current field.  All involved fields
will be overwritten.  If the rectangle does not fit into the present table,
the table is enlarged as needed.  The process ignores horizontal separator
...
(autoload 'org-table-convert "org/org-table" "\
Convert from `org-mode' table to table.el and back.
Obviously, this only works within limits.  When an Org-mode table is
converted to table.el, all horizontal separator lines get lost, because
table.el uses these as cell boundaries and has no notion of horizontal lines.
...
(autoload 'org-table-wrap-region "org/org-table" "\
Wrap several fields in a column like a paragraph.
This is useful if you'd like to spread the contents of a field over several
lines, in order to keep the table compact.
...
(autoload 'org-table-edit-field "org/org-table" "\
Edit table field in a different window.
This is mainly useful for fields that contain hidden parts.
When called with a \\[universal-argument] prefix, just make the full field visible so that
it can be edited in place.
...
(autoload 'org-table-sum "org/org-table" "\
Sum numbers in region of current table column.
The result will be displayed in the echo area, and will be available
as kill to be inserted with \\[yank].
...
(autoload 'org-table-get-stored-formulas "org/org-table" "\
Return an alist with the stored formulas directly after current table.

\(fn &optional NOERROR)" t nil)

(autoload 'org-table-maybe-eval-formula "org/org-table" "\
Check if the current field starts with \"=\" or \":=\".
If yes, store the formula and apply it.

\(fn)" nil nil)

(autoload 'org-table-rotate-recalc-marks "org/org-table" "\
Rotate the recalculation mark in the first column.
If in any row, the first field is not consistent with a mark,
insert a new column for the markers.
When there is an active region, change all the lines in the region,
...
(autoload 'org-table-maybe-recalculate-line "org/org-table" "\
Recompute the current line if marked for it, and if we haven't just done it.

\(fn)" t nil)

(autoload 'org-table-eval-formula "org/org-table" "\
Replace the table field value at the cursor by the result of a calculation.
...
(autoload 'org-table-set-constants "org/org-table" "\
Set `org-table-formula-constants-local' in the current buffer.

\(fn)" nil nil)

(autoload 'org-table-recalculate "org/org-table" "\
Recalculate the current table line by applying all stored formulas.
With prefix arg ALL, do this for all lines in the table.
With the prefix argument ALL is `(16)' (a double \\[universal-prefix] \\[universal-prefix] prefix), or if
it is the symbol `iterate', recompute the table until it no longer changes.
...
(autoload 'org-table-iterate "org/org-table" "\
Recalculate the table until it does not change anymore.
The maximum number of iterations is 10, but you can choose a different value
with the prefix ARG.
...
(autoload 'org-table-recalculate-buffer-tables "org/org-table" "\
Recalculate all tables in the current buffer.

\(fn)" t nil)

(autoload 'org-table-iterate-buffer-tables "org/org-table" "\
Iterate all tables in the buffer, to converge inter-table dependencies.

\(fn)" t nil)

(autoload 'org-table-edit-formulas "org/org-table" "\
Edit the formulas of the current table in a separate buffer.

\(fn)" t nil)

(autoload 'org-table-toggle-coordinate-overlays "org/org-table" "\
Toggle the display of Row/Column numbers in tables.

\(fn)" t nil)

(autoload 'org-table-toggle-formula-debugger "org/org-table" "\
Toggle the formula debugger in tables.

\(fn)" t nil)

(autoload 'orgtbl-mode "org/org-table" "\
The `org-mode' table editor as a minor mode for use in other modes.

\(fn &optional ARG)" t nil)

(autoload 'org-table-to-lisp "org/org-table" "\
Convert the table at point to a Lisp structure.
The structure will be a list.  Each item is either the symbol `hline'
for a horizontal separator line, or a list of field values as strings.
The table is taken from the parameter TXT, or from the buffer at point.
...
(autoload 'orgtbl-to-generic "org/org-table" "\
Convert the orgtbl-mode TABLE to some other format.
This generic routine can be used for many standard cases.
TABLE is a list, each entry either the symbol `hline' for a horizontal
separator line, or a list of fields for that line.
...
(autoload 'orgtbl-to-tsv "org/org-table" "\
Convert the orgtbl-mode table to TAB separated material.

\(fn TABLE PARAMS)" nil nil)

(autoload 'orgtbl-to-csv "org/org-table" "\
Convert the orgtbl-mode table to CSV material.
This does take care of the proper quoting of fields with comma or quotes.

\(fn TABLE PARAMS)" nil nil)

(autoload 'orgtbl-to-latex "org/org-table" "\
Convert the orgtbl-mode TABLE to LaTeX.
TABLE is a list, each entry either the symbol `hline' for a horizontal
separator line, or a list of fields for that line.
PARAMS is a property list of parameters that can influence the conversion.
...
(autoload 'orgtbl-to-html "org/org-table" "\
Convert the orgtbl-mode TABLE to HTML.
TABLE is a list, each entry either the symbol `hline' for a horizontal
separator line, or a list of fields for that line.
PARAMS is a property list of parameters that can influence the conversion.
...
(autoload 'orgtbl-to-texinfo "org/org-table" "\
Convert the orgtbl-mode TABLE to TeXInfo.
TABLE is a list, each entry either the symbol `hline' for a horizontal
separator line, or a list of fields for that line.
PARAMS is a property list of parameters that can influence the conversion.
...
(autoload 'orgtbl-to-orgtbl "org/org-table" "\
Convert the orgtbl-mode TABLE into another orgtbl-mode table.
Useful when slicing one table into many.  The :hline, :sep,
:lstart, and :lend provide orgtbl framing.  The default nil :tstart
and :tend suppress strings without splicing; they can be set to
...

;;;### (autoloads (org-timer-set-timer org-timer-item org-timer-change-times-in-region
;;;;;;  org-timer org-timer-start) "org/org-timer" "../../../org/org-timer.el"
;;;;;;  "c0a04a9b6c18954e7eadb2f39ca2e805")
;;; Generated autoloads from ../../../org/org-timer.el

(autoload 'org-timer-start "org/org-timer" "\
Set the starting time for the relative timer to now.
When called with prefix argument OFFSET, prompt the user for an offset time,
with the default taken from a timer stamp at point, if any.
If OFFSET is a string or an integer, it is directly taken to be the offset
...
(autoload 'org-timer "org/org-timer" "\
Insert a H:MM:SS string from the timer into the buffer.
The first time this command is used, the timer is started.  When used with
a \\[universal-argument] prefix, force restarting the timer.
When used with a double prefix argument \\[universal-argument], change all the timer string
...
(autoload 'org-timer-change-times-in-region "org/org-timer" "\
Change all h:mm:ss time in region by a DELTA.

\(fn BEG END DELTA)" t nil)

(autoload 'org-timer-item "org/org-timer" "\
Insert a description-type item with the current timer value.

\(fn &optional ARG)" t nil)

(autoload 'org-timer-set-timer "org/org-timer" "\
Prompt for a duration and set a timer.
...
;;;;;;  org-export-string-as org-export-as) "org/ox" "../../../org/ox.el"
;;;;;;  "76fb6fbf6c207c4514de682af5006106")
;;; Generated autoloads from ../../../org/ox.el

(autoload 'org-export-as "org/ox" "\
...
(autoload 'org-export-string-as "org/ox" "\
...
(autoload 'org-export-replace-region-by "org/ox" "\
...
(autoload 'org-export-insert-default-template "org/ox" "\
...
(autoload 'org-export-to-buffer "org/ox" "\
...
(autoload 'org-export-to-file "org/ox" "\
...
(autoload 'org-export-dispatch "org/ox" "\
...
;;;;;;  "org/ox-ascii" "../../../org/ox-ascii.el" "31dee5d02171d258b9bb18ee9aa5312a")
;;; Generated autoloads from ../../../org/ox-ascii.el

(autoload 'org-ascii-export-as-ascii "org/ox-ascii" "\
...
(autoload 'org-ascii-export-to-ascii "org/ox-ascii" "\
...
(autoload 'org-ascii-publish-to-ascii "org/ox-ascii" "\
...
(autoload 'org-ascii-publish-to-latin1 "org/ox-ascii" "\
...
(autoload 'org-ascii-publish-to-utf8 "org/ox-ascii" "\
...
;;;;;;  org-beamer-mode) "org/ox-beamer" "../../../org/ox-beamer.el"
;;;;;;  "1c70d210d85594253808321e1bd904a8")
;;; Generated autoloads from ../../../org/ox-beamer.el

(autoload 'org-beamer-mode "org/ox-beamer" "\
Support for editing Beamer oriented Org mode files.

\(fn &optional ARG)" t nil)

(autoload 'org-beamer-export-as-latex "org/ox-beamer" "\
...
(autoload 'org-beamer-export-to-latex "org/ox-beamer" "\
...
(autoload 'org-beamer-export-to-pdf "org/ox-beamer" "\
...
(autoload 'org-beamer-select-environment "org/ox-beamer" "\
...
(autoload 'org-beamer-insert-options-template "org/ox-beamer" "\
Insert a settings template, to make sure users do this right.

\(fn &optional KIND)" t nil)

(autoload 'org-beamer-publish-to-latex "org/ox-beamer" "\
...
(autoload 'org-beamer-publish-to-pdf "org/ox-beamer" "\
...
;;;;;;  "org/ox-html" "../../../org/ox-html.el" "34ee110c82e50b2994c7404c69f5b0a0")
...
(autoload 'org-html-htmlize-generate-css "org/ox-html" "\
...
(autoload 'org-html-export-as-html "org/ox-html" "\
...
(autoload 'org-html-convert-region-to-html "org/ox-html" "\
...
(autoload 'org-html-export-to-html "org/ox-html" "\
...
(autoload 'org-html-publish-to-html "org/ox-html" "\
...
;;;;;;  org-icalendar-export-to-ics) "org/ox-icalendar" "../../../org/ox-icalendar.el"
;;;;;;  "02da3bde4cd0abae11ec2334c0b3c83e")
;;; Generated autoloads from ../../../org/ox-icalendar.el

(autoload 'org-icalendar-export-to-ics "org/ox-icalendar" "\
...
(autoload 'org-icalendar-export-agenda-files "org/ox-icalendar" "\
...
(autoload 'org-icalendar-combine-agenda-files "org/ox-icalendar" "\
...
;;;;;;  org-latex-export-as-latex) "org/ox-latex" "../../../org/ox-latex.el"
;;;;;;  "a33b28d484ae85af5b338e9ef175718e")
;;; Generated autoloads from ../../../org/ox-latex.el

(autoload 'org-latex-export-as-latex "org/ox-latex" "\
...
(autoload 'org-latex-convert-region-to-latex "org/ox-latex" "\
...
(autoload 'org-latex-export-to-latex "org/ox-latex" "\
...
(autoload 'org-latex-export-to-pdf "org/ox-latex" "\
...
(autoload 'org-latex-publish-to-latex "org/ox-latex" "\
...
(autoload 'org-latex-publish-to-pdf "org/ox-latex" "\
...
;;;;;;  org-md-export-as-markdown) "org/ox-md" "../../../org/ox-md.el"
;;;;;;  "9613796f5e2e5a59ccd56f1fb52df3c7")
;;; Generated autoloads from ../../../org/ox-md.el

(autoload 'org-md-export-as-markdown "org/ox-md" "\
...
(autoload 'org-md-convert-region-to-md "org/ox-md" "\
...
(autoload 'org-md-export-to-markdown "org/ox-md" "\
...
;;;;;;  org-odt-export-as-odf) "org/ox-odt" "../../../org/ox-odt.el"
;;;;;;  "d211042456ad899332c26ca9dcad8724")
;;; Generated autoloads from ../../../org/ox-odt.el

(put 'org-odt-preferred-output-format 'safe-local-variable 'stringp)

(autoload 'org-odt-export-as-odf "org/ox-odt" "\
...
(autoload 'org-odt-export-as-odf-and-open "org/ox-odt" "\
...
(autoload 'org-odt-export-to-odt "org/ox-odt" "\
...
(autoload 'org-odt-convert "org/ox-odt" "\
...
;;;;;;  "org/ox-org" "../../../org/ox-org.el" "0b39e4bd2eb545309d3495257b1ced80")
;;; Generated autoloads from ../../../org/ox-org.el

(autoload 'org-org-export-as-org "org/ox-org" "\
...
(autoload 'org-org-export-to-org "org/ox-org" "\
...
(autoload 'org-org-publish-to-org "org/ox-org" "\
...
;;;;;;  org-publish-all org-publish) "org/ox-publish" "../../../org/ox-publish.el"
;;;;;;  "5ece54cc06ba971c01450eb7a8359e21")
;;; Generated autoloads from ../../../org/ox-publish.el

(defalias 'org-publish-project 'org-publish)

(autoload 'org-publish "org/ox-publish" "\
Publish PROJECT.
...
(autoload 'org-publish-all "org/ox-publish" "\
...
(autoload 'org-publish-current-file "org/ox-publish" "\
...
(autoload 'org-publish-current-project "org/ox-publish" "\
...
;;;;;;  "org/ox-texinfo" "../../../org/ox-texinfo.el" "84c96e4b93249af64d8e4a3959149d33")
;;; Generated autoloads from ../../../org/ox-texinfo.el

(autoload 'org-texinfo-publish-to-texinfo "org/ox-texinfo" "\
...
(autoload 'org-texinfo-convert-region-to-texinfo "org/ox-texinfo" "\
